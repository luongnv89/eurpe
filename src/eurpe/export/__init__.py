...
class). Export depends on generation; generation never depends on
export. This one-way dependency avoids the cycle the previous
service-boundary design risked.
"""
